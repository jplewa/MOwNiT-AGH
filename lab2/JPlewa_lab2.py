...
def ex2():
    with open("./cubic.txt", "r") as cubic_file:
        xs = []
        cubic = []
    ...
    with open("./lagrange.txt", "r") as lagrange_file:
        lagrange = []
...
def ex6():
    ...
    plt.scatter(xs_sorted, predicted_ys_sorted, marker='*', color='orange', label='predicted y')
